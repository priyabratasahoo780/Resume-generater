  ...
  return (
    <div className="h-screen bg-slate-50 flex flex-col font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden mx-auto w-full h-full relative">
        {/* Left Panel: Editor */}
        <div className={`w-full lg:w-[40%] lg:border-r border-slate-200 bg-white overflow-y-auto z-[60] shadow-sm relative h-full flex-shrink-0 lg:flex-shrink ${activeTab === 'edit' ? 'block' : (isEditorHidden ? 'hidden' : 'hidden lg:block')}`}>
          <EditorPanel 
